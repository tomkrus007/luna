...
#ifndef LUNACALENDAR_SWIFT_H
#define LUNACALENDAR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LunaCalendar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12LunaCalendar11AppDelegate")
...
@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC12LunaCalendar24CalendarWindowController")
@interface CalendarWindowController : NSWindowController
